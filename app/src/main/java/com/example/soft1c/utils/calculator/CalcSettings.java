...
public class CalcSettings implements Parcelable {
    ...
    public void writeToParcel(@NonNull Parcel out, int flags) {
        ...
        try {
            ...
            Timber.tag(TAG).e("Failed to parcel Bundle.");
        }
    }
    ...
    private NumberFormat getNumberFormatFromBundle(Bundle bundle) {
        ...
        try {
            ...
            if (nbFmt != null) {
                try {
                    ...
                    if (nbFmt.getRoundingMode() == null) {
                        ...
                        Timber.tag(TAG).e("Failed to deserialize DecimalFormat rounding mode, reset to HALF_EVEN.");
                    }
                } catch (UnsupportedOperationException uoe) {
            ...
            if (bundle.containsKey("nbfmtPattern")) {
                ...
                Timber.tag(TAG).e("Failed to deserialize NumberFormat.");
            }
